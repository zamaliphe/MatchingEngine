<div id="content">
            ...
            <ul>
                ...
                <li class="has">
                    <a title="">
                        ...
                        <span>Invoices</span>
                        <span><?php echo $this->Html->image('admin/elements/control/hasddArrow.png',array()); ?></span>
                    </a>
                    <ul>
    ...
    <div class="wrapper">
        <ul class="middleNavR">
            <li><a href="#" title="Add an article" class="tipN"><?php echo $this->Html->image('admin/icons/middlenav/create.png',array()); ?></a></li>
            <li><a href="#" title="Upload files" class="tipN"><?php echo $this->Html->image('admin/icons/middlenav/upload.png',array()); ?></a></li>
            <li><a href="#" title="Add something" class="tipN"><?php echo $this->Html->image('admin/icons/middlenav/add.png',array()); ?></a></li>
            <li><a href="#" title="Messages" class="tipN"><?php echo $this->Html->image('admin/icons/middlenav/dialogs.png',array()); ?></a><strong>8</strong></li>
            <li><a href="#" title="Check statistics" class="tipN"><?php echo $this->Html->image('admin/icons/middlenav/stats.png',array()); ?></a></li>
        </ul>
        ...
        <div class="fluid">
            ...
            <div class="widget grid6">
                ...
                <ul class="messagesOne">
                    <li class="by_user">
                        <a href="#" title=""><?php echo $this->Html->image('admin/live/face1.png',array()); ?></a>
                    ...
                    <li class="by_me">
                        <a href="#" title=""><?php echo $this->Html->image('admin/live/face2.png',array()); ?></a>
                        <div class="messageArea">
                            <span class="aro"></span>
                            <div class="infoRow">
        ...
        <div id="dyn" class="hiddenpars">
            <a class="tOptions" title="Options"><?php echo $this->Html->image('admin/icons/options',array()); ?></a>
        ...
        <div class="fluid">
          ...
          <div class="widget check grid6">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="tDefault checkAll tMedia" id="checkAll">
                <thead>
                    <tr>
                        <td><?php echo $this->Html->image('admin/elements/other/tableArrows.png',array()); ?></td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="images/big.png" title="" class="lightbox"><?php echo $this->Html->image('admin/live/face3.png',array()); ?></a></td>
                    ...
                    <tr>
                        <td><input type="checkbox" name="checkRow" /></td>
                        <td><a href="images/big.png" title="" class="lightbox"><?php echo $this->Html->image('admin/live/face7.png',array()); ?></a></td>
                        <td class="textL"><a href="#" title="">Image1 description</a></td>
                        <td>Feb 12, 2012. 12:28</td>
                        <td class="fileInfo"><span><strong>Size:</strong> 215 Kb</span><span><strong>Format:</strong> .jpg</span></td>
                        <td class="tableActs">
                    ...
                    <tr>
                        <td><input type="checkbox" name="checkRow" /></td>
                        <td><a href="images/big.png" title="" class="lightbox"><?php echo $this->Html->image('admin/live/face6.png',array()); ?></a></td>
                        <td class="textL"><a href="#" title="">Image1 description</a></td>
                        <td>Feb 12, 2012. 12:28</td>
                        <td class="fileInfo"><span><strong>Size:</strong> 215 Kb</span><span><strong>Format:</strong> .jpg</span></td>
                        <td class="tableActs">
                    ...
                    <tr>
                        <td><input type="checkbox" name="checkRow" /></td>
                        <td><a href="images/big.png" title="" class="lightbox"><?php echo $this->Html->image('admin/live/face5.png',array()); ?></a></td>
                        <td class="textL"><a href="#" title="">Image1 description</a></td>
                        <td>Feb 12, 2012. 12:28</td>
                        <td class="fileInfo"><span><strong>Size:</strong> 215 Kb</span><span><strong>Format:</strong> .jpg</span></td>
                        <td class="tableActs">
