<div class="users form">
    ...
    <?php echo $this->element('admin/forms/form_header', array("form_label" => "Add User")); ?>
    ...
    <?php echo $this->element('admin/forms/input_row', array("input_label" => "Profile Img", "input_name" => "profile_img")); ?>
