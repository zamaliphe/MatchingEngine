<?php echo $this->element('front/forms/form_header',array("form_label"=>"Users" )); ?>
<?php echo $this->element('front/forms/table_toolbar',array()); ?>
...
<table cellpadding="0" cellspacing="0" width="100%" class="tDefault checkAll tMedia" id="checkAll"> 
    ...
    <?php echo $this->element('front/forms/form_paging',array("colspan"=>8)); ?>
    <tbody>
        <?php foreach ($users as $user): ?>
            <tr>
                ...
                <?php echo $this->element('front/forms/form_action', array("item_id" => $user['User']['id'], "item_name" => $user['User']['username'])); ?>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
<?php echo $this->element('front/forms/form_index_footer'); ?>