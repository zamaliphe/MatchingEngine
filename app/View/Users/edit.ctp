<div class="users form">		
    ...
    <?php echo $this->element('front/forms/form_header', array("form_label" => "Edit User")); ?>
    ...
    <?php echo $this->element('front/forms/input_row', array("input_label" => "Profile_img", "input_name" => "profile_img")); ?>
