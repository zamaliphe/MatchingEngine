...
*/
	...
	public function admin_itemperpage($limit = 10)
	{
		...
		$response = array("ok" => true, "success" => $success);
	...
	{
		$icons = array(
			array('title' => 'Sites Manage', 'image' => 'layout.png', 'link' => array('plugin' => null, 'controller' => 'sites', 'action' => 'index'), 'class' => 'productpacks'),
			array('title' => 'Add Site', 'image' => 'useradd.png', 'link' => array('plugin' => null, 'controller' => 'sites', 'action' => 'add'), 'class' => 'addcontent'),
			array('title' => 'Site Layouts', 'image' => 'sysinfo.png', 'link' => array('plugin' => null, 'controller' => 'site_themes', 'action' => 'index'), 'class' => 'layout'),
			array('title' => 'Add Layout', 'image' => 'contentadd.png', 'link' => array('plugin' => null, 'controller' => 'site_themes', 'action' => 'add'), 'class' => 'layout'),
			array('title' => 'Statistics', 'image' => 'sysstats.png', 'link' => array('plugin' => null, 'controller' => 'admindashboard', 'action' => 'statistics'), 'class' => 'sysstats'),
			array('title' => 'System Logs', 'image' => 'syslogs.png', 'link' => array('plugin' => null, 'controller' => 'admindashboard', 'action' => 'logs'), 'class' => 'syslogs'),
			array('title' => 'System Info', 'image' => 'sysinfo.png', 'link' => array('plugin' => null, 'controller' => 'admindashboard', 'action' => 'sysinfo'), 'class' => 'sysinfo'),
			array('title' => 'Settings', 'image' => 'settings.png', 'link' => array('plugin' => null, 'controller' => 'settings', 'action' => 'settings'), 'class' => 'settings'),
		);
